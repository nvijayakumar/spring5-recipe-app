...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>{
	...
	private List<Recipe> getRecipes() {
		...
		//get UOMs
        UnitOfMeasure eachUom = unitOfMeasureRepository.findByUom("Each")
            	.orElseThrow(() -> new RuntimeException("Expected UOM Not Found - Each"));

        UnitOfMeasure tableSpoonUom = unitOfMeasureRepository.findByUom("Tablespoon")
        	.orElseThrow(() -> new RuntimeException("Expected UOM Not Found - Tablespoon"));

        UnitOfMeasure teapoonUom = unitOfMeasureRepository.findByUom("Teaspoon")
        		.orElseThrow(() ->  new RuntimeException("Expected UOM Not Found - Teaspoon"));
        		
        UnitOfMeasure dashUom = unitOfMeasureRepository.findByUom("Dash")
        		.orElseThrow(() -> new RuntimeException("Expected UOM Not Found - Dash"));

        UnitOfMeasure pintUom = unitOfMeasureRepository.findByUom("Pint")
        		.orElseThrow(() ->  new RuntimeException("Expected UOM Not Found - Pint"));

        UnitOfMeasure cupsUom = unitOfMeasureRepository.findByUom("Cup")
        		.orElseThrow(() ->  new RuntimeException("Expected UOM Not Found - Cup"));

        //get Categories
        Category americanCategory = categoryRepository.findByDescription("American")
        		.orElseThrow(() -> new RuntimeException("Expected Category Not Found - American"));

        Category mexicanCategory = categoryRepository.findByDescription("Mexican")
        		.orElseThrow(() -> new RuntimeException("Expected Category Not Found - Mexican"));
        ...
        //Recipe.setNotes will make the bidirectional mapping
